export const pieces={
 'quadril-real':{name:'Quadril · digitalização real',description:'Osso do quadril esquerdo digitalizado. Explore os relevos nas faces lateral e medial. Para ver também o sacro e outros acidentes, abra Pelve e sacro.',side:'esquerda'},
 'l5-real':{name:'L5 · digitalização real',description:'Quinta vértebra lombar digitalizada de uma peça anatômica. Comece pela vista superior para localizar o corpo, o forame e os processos.',side:'direita'},
...
export function pieceRoute(hash){const p=new URLSearchParams(hash.replace(/^#/,''));return {piece:Object.hasOwn(pieces,p.get('peca'))?p.get('peca'):'quadril-real',point:p.get('ponto')||null};}
